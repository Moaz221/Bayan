      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10">
        ...
        >
          ...
          <h2 className="font-amiri text-3xl lg:text-5xl font-black luxury-section-title">
            منصة تعليمية معتمدة للطلاب في الثانوية والبكالوريا
          </h2>

          <p className="mt-3 text-sm lg:text-base text-gray-400">
            بَيان توفر شرحًا منظمًا، امتحانات تفاعلية، ومتابعة مستمرة لطلاب الصف الأول والثاني والثالث الثانوي، مع باقات اشتراك مرنة تناسب كل مرحلة.
          </p>
        </motion.div>
